...
namespace Frontend.Services
{
    public class TalentoService
    {
        ...
        {
            return await _httpClient.GetFromJsonAsync<List<TalentoDTO>>("api/talento/index");
        }
        ...
        public async Task<TalentoDTO?> GetTalentoByIdAsync(int id)
        {
            try
            {
                var response = await _httpClient.GetAsync($"api/talento/{id}");
        ...
        {
            var response = await _httpClient.PostAsJsonAsync("api/talento/create", createTalentoDTO);
        ...
        {
            var url = $"api/talento/{talento.Talentoid}";
        ...
        {
            var response = await _httpClient.DeleteAsync($"api/talento/{id}");
